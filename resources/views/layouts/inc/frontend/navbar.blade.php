<style>
    .main-navbar .top-navbar {
        background-color: {{ $appSetting->header_color ?? '#000000' }};
        padding: 14px;
    }
</style>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    ...
                    @if(isset($appSetting->brand_logo) && !empty($appSetting->brand_logo))
                    <img src="{{ asset($appSetting->brand_logo) }}" alt="Brand Logo" class="img-fluid" width="50">
                    @else
