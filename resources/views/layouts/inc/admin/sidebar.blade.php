  ...
  <ul class="nav">
    <li class="nav-item {{ Request::is('admin/dashboard') ? 'active':''}}">
      <a class="nav-link" href="{{ url('admin/dashboard') }}">
        ...
        <span class="menu-title">Fuerte developers</span>
      </a>
    </li>
  ...
  <li class="nav-item  {{ Request::is('admin/colors') ? 'active':''}}">
    ...
    <li class="nav-item {{ Request::is('admin/settings*') ? 'active':''}}">
        ...
        <div class="collapse {{ Request::is('admin/settings*') ? 'show':''}}" id="settings">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link {{ Request::is('admin/settings') ? 'active':''}}" href="{{ url('admin/settings') }}">Edit Text</a>
              </li>
            <li class="nav-item">
              <a class="nav-link {{ Request::is('admin/settings/colors') ||  Request::is('admin/settings') ? 'active':''}}" href="{{ url('admin/settings/colors') }}">Edit Color</a>
            </li>
          </ul>
        </div>
      </li>
