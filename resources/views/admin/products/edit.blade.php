        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="datails-tab" data-bs-toggle="tab" data-bs-target="#datails-tab-pane" type="button" role="tab" aria-controls="datails-tab-pane" aria-selected="false">Details</button>
                    </li>
                    <li class="nav-item" role="presentation">
