                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="website_name" value="{{ $appSetting->website_name ?? ''}}" class="form-control">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label>Brand Logo</label>
                            <input type="file" name="brand_logo" class="form-control">
                            <img src="{{asset("$appSetting->brand_logo")}}" width=100  alt="brand_logo">
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="email1" value="{{ $setting->email1 ?? ''}}" class="form-control" rows="3">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label>Email Id 2</label>
                            <input type="text" name="email2" value="{{ $setting->email2 ?? ''}}" class="form-control" rows="3">
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="youtube" value="{{ $setting->youtube ?? ''}}"  class="form-control" rows="3">
                        </div>
                    </div>
                </div>
            </div>
