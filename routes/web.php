...
Route::get('admin/settings/colors', [ColorSettingController::class, 'editColors'])->name('admin.setting.colors');
Route::post('admin/settings/colors/save', [ColorSettingController::class, 'saveColors'])->name('admin.setting.colors.save');
